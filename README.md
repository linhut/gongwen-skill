...
[![PyPI](https://img.shields.io/badge/PyPI-v2.0.0-blue)](https://pypi.org/project/gongwen-skill/)
...
python -m gongwen --version       # 检验：gongwen-skill v2.0.0
```
...
| DSH 配置化排版参数（页边距/行距/字体/默认模板版本） | ✅ v2.0.0+ |
