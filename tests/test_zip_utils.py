...
class TestRegisterContentType:
    def test_register_new(self):
        xml = b'<?xml version="1.0" encoding="UTF-8" standalone="yes"?>\n<Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types"></Types>'  # noqa: E501
    ...
    def test_skip_existing(self):
        xml = b'<?xml version="1.0" encoding="UTF-8" standalone="yes"?>\n<Types xmlns="http://schemas.openxmlformats.org/package/2006/content-types"><Override PartName="/word/test.xml" ContentType="application/xml"/></Types>'  # noqa: E501
        result = register_content_type(xml, "/word/test.xml", "application/xml")
        root = etree.fromstring(result)
        overrides = root.findall("{http://schemas.openxmlformats.org/package/2006/content-types}Override")
...
class TestRegisterRelationship:
    def test_register_new(self):
        xml = b'<?xml version="1.0" encoding="UTF-8" standalone="yes"?>\n<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"></Relationships>'  # noqa: E501
    ...
    def test_skip_duplicate_target(self):
        xml = b'<?xml version="1.0" encoding="UTF-8" standalone="yes"?>\n<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Type="http://test/rel" Target="test/target"/></Relationships>'  # noqa: E501
        result = register_relationship(xml, "http://test/rel", "test/target")
        root = etree.fromstring(result)
        rels = root.findall("{http://schemas.openxmlformats.org/package/2006/relationships}Relationship")
        assert len(rels) == 1
    ...
    def test_rid_increments(self):
        xml = b'<?xml version="1.0" encoding="UTF-8" standalone="yes"?>\n<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId5" Type="http://a" Target="a"/></Relationships>'  # noqa: E501
