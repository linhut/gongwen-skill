...
> ✏️ **`revise` 只改内容不改格式**，安全。自动三段式输出。

### 三段式输出说明

```
┌─ 第一段：交互确认（对话框） ──────────────────────────┐
│  ⚠️ 注意：revise 命令 ✏️ 仅修改内容，不改变原文排版格式  │
│  将生成内容修订对比文档，是否继续？[Y/n]                  │
└──────────────────────────────────────────────────────┘
...
┌─ 第三段：修改建议与说明（文档末尾 + 对话框同步） ────────┐
│  📋 修改建议与说明（共修改 2 处、删除 1 处、新增 1 处） │
│  ──────────────────────────────────────────────────   │
│    • 修改第 1 处：优化措辞                              │
│      原文：「原始文字」                                  │
│      修订：「修改后文字」                                 │
