...
```
第一段：交互确认 — 先展示修改概览，用户确认后才生成
═══════════════════════════════════════════════
⚠️ 注意：revise 命令 ✏️ 仅修改内容，不改变原文排版格式
   共 5 段，其中修改 3 处、删除 1 处、新增 1 处
   将生成内容修订对比文档，是否继续？[Y/n]

第二段：文档对比 — 原文对照 + 红色标注 + 首句加粗
═══════════════════════════════════════════════
📝 修订：现将2026年第二季度...   ← 🔴 红色字体（首句加粗）
⚪ 原文：现将2026年第二季度...   ← 🔴 红色 + 删除线
💡 修改说明：优化措辞

🆕 新增：各部门要高度重视...     ← 🔴 红色字体
⚠ 删除：加强组织领导           ← 🔴 红色 + 删除线

第三段：修改建议与说明 — 文档末尾 + 对话框同步输出
═══════════════════════════════════════════════
📋 修改建议与说明（共修改 3 处、删除 1 处、新增 1 处）
────────────────────────────────────────────
  • 修改第 1 处：优化措辞
    原文：「现将2026年第二季度工作...」
    修订：「现将2026年第二季度工作...」
